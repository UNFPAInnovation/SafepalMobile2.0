...
public class QuestiontableContentValues extends AbstractContentValues {
    ...
    public QuestiontableContentValues putServerid(@Nullable String value) {
    ...
    public QuestiontableContentValues putCorrectAnswer(@Nullable Integer value) {
    ...
    public QuestiontableContentValues putPosition(@Nullable Integer value) {
        mContentValues.put(QuestiontableColumns.POSITION, value);
        return this;
    }

    public QuestiontableContentValues putPositionNull() {
        mContentValues.putNull(QuestiontableColumns.POSITION);
        return this;
    }
